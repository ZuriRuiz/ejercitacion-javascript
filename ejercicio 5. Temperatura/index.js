...
y con ese dato modifique un h1 en el documento HTML, de forma tal que diga, por ejemplo, Temperatura actual: 20° 
y cambie el color siguiendo la siguiente tabla:
...
const temperaturaUsuario = prompt("ingrese temperatura actual");

temperatura.textContent = `Temperatura actual: ${temperaturaUsuario}`;

if(temperaturaUsuario < 0){
    temperatura.style.color = "#0078d7";
}if(temperaturaUsuario >= 0 && temperaturaUsuario < 15){
    temperatura.style.color = "#a0e6fe";
}if(temperaturaUsuario >= 15 && temperaturaUsuario < 25){
    temperatura.style.color = "#61c9a8";
}if(temperaturaUsuario >= 25 && temperaturaUsuario < 30){
    temperatura.style.color = "#ffff66";
}if(temperaturaUsuario >= 30 && temperaturaUsuario < 35){
    temperatura.style.color = "#fbc165";
}if(temperaturaUsuario > 35){
